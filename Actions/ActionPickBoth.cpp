#include "ActionPickBoth.h"
#include "../ApplicationManager.h"
#include"../Figures/CFigure.h"
#include"../GUI/GUI.h"
#include <iostream>

ActionPickBoth::ActionPickBoth(ApplicationManager* pApp) :Action(pApp)
{
	correctAns = 0;
	wrongAns = 0;
	score = 0;
...
bool ActionPickBoth::doesFigureMatch(CFigure* figure, CFigure* targetFigure)
{
...
int ActionPickBoth::getMatchingFigCount(CFigure* targetFigure)
{
	...
	{
		CFigure* currentFig = pManager->getFiguresList()[i];
